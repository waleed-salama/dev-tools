...
const defaultClasses =
  "animate-spin h-10 w-10 fill-slate-600 text-slate-200 dark:fill-slate-200 dark:text-slate-600";
...
const Spinner = ({ className }: SpinnerProps) => {
   ...
   * @param {string} className -  h-10 w-10 fill-primary-600 text-neutral-200
   */
  let finalClassName = "";
  if (className) {
    const classes = className.split(" ");
    let finalClasses = defaultClasses.split(" ");
